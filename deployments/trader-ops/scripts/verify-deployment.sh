...
grep -q 'id: quick_command_plan' <<<"$dump_output"
grep -q 'toolName: mcp__bssh-ops-remote__check_process_status' <<<"$dump_output"
grep -q 'toolName: mcp__bssh-ops-remote__execute_quick_command_plan' <<<"$dump_output"
